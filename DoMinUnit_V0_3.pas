...
procedure DrawRawBoard(DrawRawBoard_ProgramVariable: ProgramVariable);
    ...
    begin
        ...
        TVWriteln('Đã thấy ' + IntToStr(DrawRawBoard_ProgramVariable.Boom.found) + '/' + IntToStr(DrawRawBoard_ProgramVariable.Boom.Number) + ' quả bom');
        ...
        do begin
            ...
            do begin
                ...
                then TVWrite(DrawRawBoard_ProgramVariable.console.char)
                else begin 
                    textcolor(blue);
                    TVWrite(DrawRawBoard_ProgramVariable.Board[DrawRawBoard_i, DrawRawBoard_j].Value);
                end;
            end;
        end;
    end;
function DrawBoard(DrawBoard_ProgramVariable: ProgramVariable): ProgramVariable;
    ...
    begin
        ...
        do begin
            ...
            do begin                
                ...
                then begin
                    ...
                    then TVWrite(DrawBoard.Board[DrawBoard_i, DrawBoard_j].Value)
                    else 
                    if 
                        (DrawBoard.board[DrawBoard_i, DrawBoard_j].show = 1)
                        and 
        ...
        TVWriteln('Đã thấy ' + IntToStr(DrawBoard.Boom.found) + '/' + IntToStr(DrawBoard.Boom.Number) + ' quả bom');
        if 
...
procedure resetFootprint(resetFootprint_X, resetFootprint_Y: integer; 
    ...
    begin
        ...
        then begin
            textcolor(blue);
            TVWrite(resetFootprint_ProgramVariable.Board[resetFootprint_X, resetFootprint_Y].Value);            
        end
        else begin
            
            TVWrite(resetFootprint_ProgramVariable.console.char);
        end;
    end;
procedure make_Footprint(make_Footprint_X, make_Footprint_Y: integer;
                         make_Footprint_ProgramVariable: ProgramVariable
    ...
    begin
        ...
        then TVWrite(make_Footprint_ProgramVariable.board[make_Footprint_X, make_Footprint_Y].Value)
        else TVWrite(make_Footprint_ProgramVariable.console.char);        
    end;
...
function MessageToQuit(MessageToQuit_input: string;
    ...
    begin        
        ...
        gotoXY(1, MessageToQuit_ProgramVariable.Y.max + 2);
